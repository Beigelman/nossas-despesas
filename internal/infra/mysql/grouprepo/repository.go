...
func NewMySqlRepository(db db.Database) repository.GroupRepository {
	return &MySqlGroupRepository{db: db.Client()}
}

// GetNextID implements group.UserRepository.
func (repo *MySqlGroupRepository) GetNextID() entity.GroupID {
	var nextValue int
...
func (repo *MySqlGroupRepository) GetByID(ctx context.Context, id entity.GroupID) (*entity.Group, error) {
...
func (repo *MySqlGroupRepository) GetByName(ctx context.Context, name string) (*entity.Group, error) {
	var model GroupModel
...
func (repo *MySqlGroupRepository) Store(ctx context.Context, entity *entity.Group) error {
...
func (repo *MySqlGroupRepository) create(ctx context.Context, model GroupModel) error {
...
func (repo *MySqlGroupRepository) update(ctx context.Context, model GroupModel) error {
