...
func NewMySqlRepository(db db.Database) repository.UserRepository {
	return &MySqlUsersRepository{db: db.Client()}
}

// GetNextID implements user.UserRepository.
func (repo *MySqlUsersRepository) GetNextID() entity.UserID {
	var nextValue int
...
func (repo *MySqlUsersRepository) GetByID(ctx context.Context, id entity.UserID) (*entity.User, error) {
	var model UserModel
...
func (repo *MySqlUsersRepository) GetByEmail(ctx context.Context, email string) (*entity.User, error) {
	var model UserModel
...
func (repo *MySqlUsersRepository) Store(ctx context.Context, entity *entity.User) error {
...
func (repo *MySqlUsersRepository) create(ctx context.Context, model UserModel) error {
...
func (repo *MySqlUsersRepository) update(ctx context.Context, model UserModel) error {
