...
type (
	...
	InviteUserToGroup func(ctx context.Context, input InviteUserToGroupInput) (*entity.GroupInvite, error)
)
...
func NewInviteUserToGroup(
	...
	return func(ctx context.Context, input InviteUserToGroupInput) (*entity.GroupInvite, error) {
